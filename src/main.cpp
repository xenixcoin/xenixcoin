...
unsigned int nTargetSpacing = 600; // 60 seconds
...
const string strMessageMagic = "xenixcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "xenixcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Xenix November 2016";
        CTransaction txNew;
        txNew.nTime = 1478537583;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478537583;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1039608;
		if(fTestNet)
        {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x14d51d494c41b2e8443370563e2f1978f323e0a4435f92182a20de645eff1587"));
        block.print();
